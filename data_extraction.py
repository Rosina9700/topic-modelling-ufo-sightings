...
def read_json(filename):
    '''
    Open a json file, take the html tag and create a BeautifulSoup. Find the table and
    take the contents from the 1st and 2nd row.
    PARAMETERS
    ----------
    filename: String
    RETURNS
...
def extract_data(report):
    '''
    Extract the required text from the string using prior knowledge of the structure
    of the string. Skip when this throws an error.
    PARAMETERS
    ----------
    filename: String
    RETURNS
